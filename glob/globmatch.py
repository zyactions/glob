...
parser.add_argument("--shell-output", action=argparse.BooleanOptionalAction,
                    help='Delimit matching elements with spaces instead of newlines and enable shell quoting')
...
for line in sys.stdin:
    ...
    if glob.globmatch(filename, patterns=patterns, limit=100, flags=
        ...
        print(filename, end=' ' if args.shell_output else None)
